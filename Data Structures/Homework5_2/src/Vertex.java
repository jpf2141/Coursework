...
public class Vertex implements Comparable {
	...
	/**
	 * adds v to this's adj list and this to v's adj list
	 * @param v
	 * @param dist
	 */
	public void makeAdjacent(Vertex v, double dist) { 
	...
	/**
	 * Testing methods
	 * Prints the list of vertices, as well as some of their characteristics 
	 * @param list
	 */
